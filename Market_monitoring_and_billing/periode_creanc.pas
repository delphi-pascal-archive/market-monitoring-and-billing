...
var
  periode_creance: Tperiode_creance;
  DATE1,date2 :string;
implementation

uses MODULE_TABLE, creance_periode, chiffre_periode;

{$R *.dfm}

procedure Tperiode_creance.DateTimePicker1Change(Sender: TObject);
begin
   MaskEdit1.Text:=datetostr(DateTimePicker1.date);
end;

procedure Tperiode_creance.DateTimePicker2Change(Sender: TObject);
begin
 MaskEdit2.Text:=datetostr(DateTimePicker2.date);
end;

procedure Tperiode_creance.SpeedButton1Click(Sender: TObject);
var xx:string;
begin
  ...
  while not module1.ETAT.Eof do
   begin
    ...
    module1.ETAT.Next;
        ...
        creance_period.Query1.Active:=false;
        creance_period.Query1.Active:=true;
         With  creance_period.Query1 do
         begin
          Close;
          Unprepare;
